...
(function () {
  ...
  function priceParts(checkIn, checkOut, pets) {
    ...
    var dueToday = first30 + C.CLEANING + petFee + C.DEPOSIT;
    var monthlyRate = C.MIN_NIGHTS * C.NIGHTLY;
    var fullTotal = n * C.NIGHTLY + C.CLEANING + petFee + C.DEPOSIT;
    var paymentDates = [];
    ...
    return {
      n: n, first30: first30, cleaning: C.CLEANING, deposit: C.DEPOSIT,
  ...
  window.RISE_CORE = {
    MIN_NIGHTS: C.MIN_NIGHTS, NIGHTLY: C.NIGHTLY, CLEANING: C.CLEANING, DEPOSIT: C.DEPOSIT,
