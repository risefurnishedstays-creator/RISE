...
(function () {
  ...
  @media (max-width: 640px) {
    ...
    header.nav .nav-inner { height: 62px; }
    .nav-cta { gap: 8px; }
  }
  ...
  /* unit spec strip: let it wrap instead of overflowing */
  @media (max-width: 720px) {
    .specs { flex-wrap: wrap !important; justify-content: flex-start !important; }
    .specs span { border-left: none !important; padding: 8px 14px 8px 0 !important; }
    .specs span:first-child { padding-left: 0 !important; }
  }
