...
function guestConfirmationEmail({ guestName, unitName, checkIn, checkOut, nights, dueToday, fullTotal, schedule, confirmationCode }) {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p style="margin:4px 0;"><strong>Paid today:</strong> ${money(dueToday)} (first 30 nights + cleaning + refundable deposit${schedule && schedule.length ? "" : ""})</p>
...
function ownerNotificationEmail({ guestName, guestEmail, unitName, checkIn, checkOut, nights, dueToday, fullTotal, schedule, confirmationCode }) {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p style="color:#888; font-size:12px; margin-top:24px;">Remember: the ${money(500)} deposit is refundable — refund it via the Stripe dashboard after checkout.</p>
    </div>`;
}
