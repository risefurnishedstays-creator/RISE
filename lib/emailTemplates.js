...
function guestConfirmationEmail({ guestName, unitCode, unitName, checkIn, checkOut, nights, dueToday, fullTotal, schedule, confirmationCode }) {
  ...
  const body = `
    ...
    ${calloutBox(`<strong>ACTION REQUIRED:</strong> <strong>Your booking isn't complete yet.</strong> You still need to sign your lease and send a photo ID to <a href="mailto:risefurnishedstays@gmail.com" style="color:${BRAND.orange}; font-weight:bold;">risefurnishedstays@gmail.com</a> before your stay is confirmed. We'll email your lease shortly.`, { tone: "warn" })}
