...
function guestConfirmationEmail({ guestName, unitCode, unitName, checkIn, checkOut, nights, dueToday, fullTotal, schedule, confirmationCode }) {
  ...
  const body = `
    ...
    ${calloutBox(`<strong>ACTION REQUIRED:</strong> <strong>Your booking isn't complete yet.</strong> Please sign your lease within <strong>3 days</strong> or your booking will be cancelled, and upload a photo of your government-issued ID before your stay is confirmed.`, { tone: "warn" })}
