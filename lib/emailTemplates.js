...
function outcomeSummaryRow(outcome) {
  ...
  if (outcome.branch === "non-refundable") {
    return `<tr><td style="padding:8px 0; font-weight:bold; width:170px;">Refund amount:</td><td style="padding:8px 0;">$0 — first month's rent and cleaning/pet fees are non-refundable inside 30 days of check-in</td></tr>`;
  }
  // midstay
