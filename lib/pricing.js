...
function cancellationOutcome(checkInStr, checkOutStr, noticeDate, pets) {
  ...
  if (stayInProgress) {
    ...
    const liabilityAmount = liableNights * CONFIG.NIGHTLY;
...
module.exports = { CONFIG, priceParts, validateBooking, cancellationOutcome, checkinEmailTiming, cancellationCutoffDates, key, parseKey, addDays, nightsBetween };
