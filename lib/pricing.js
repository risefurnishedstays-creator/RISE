...
function cancellationOutcome(checkInStr, checkOutStr, noticeDate, pets) {
  ...
  const feeRefund = moreThan30DaysOut ? (CONFIG.CLEANING + pets * CONFIG.PET_FEE) : 0;
  ...
  return {
    ...
    message: moreThan30DaysOut
      ...
      : "Cancelled 30 days or fewer before check-in: first month's rent, cleaning fee, and pet fee(s) are non-refundable.",
  };
}
