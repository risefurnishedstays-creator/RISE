...
Within 5 days of booking: If Tenant cancels within 5 days (120 hours) of the date this booking was made, Tenant's first month's rent, cleaning fee, and any pet fee(s) will be refunded in full. If Tenant's card has not yet been charged at the time of cancellation (it is held, not charged, until that 5-day window closes), the hold is released instead of a refund being issued.

More than 5 days after booking, but more than 30 days before check-in: If Tenant cancels after the 5-day window above, but by ${fmtLongDate(fullRefundCutoff)}, the cleaning fee and any pet fee(s) will be refunded in full, and 90% of Tenant's first month's rent will be refunded (10% is retained by Landlord).
