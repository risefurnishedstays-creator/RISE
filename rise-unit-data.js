...
const UNIT_B = {
  ...
  overview: [
    ...
    "Centrally located between I-35 and South Lamar, this is the only pet-friendly home in the fourplex.",
    OVERVIEW_BASE[3],
  ],
  highlights: [
...
const UNIT_D = {
  ...
  overview: [
    OVERVIEW_BASE[0],
    OVERVIEW_BASE[1],
    "Centrally located between I-35 and South Lamar, with easy access to downtown Austin, major employers, hospitals, and the city's best food and coffee.",
    OVERVIEW_BASE[3],
  ],
  highlights: [
    { ic: "🌿", t: "Cozy backyard" },
